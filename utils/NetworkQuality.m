function [completeness correctness rmse] = NetworkQuality(refLine, extLine, labels, img)
...
for j=1:size(refLine,2)
    ...
    if(~isempty(matched_reference{j}))
        ...
        line([ref_line.s(2) ref_line.e(2)],[ref_line.s(1) ref_line.e(1)],'Color',[0 0.5 0],'LineWidth',3);
...
%             scatter(mline.e(2), mline.e(1), 'b','o','LineWidth', 3);
            ...
            line([prj1(2) prj2(2)], [prj1(1) prj2(1)],'Color',[0 0 1],'LineWidth',3, 'LineStyle', '--');
            
            scatter(prj1(2), prj1(1), 'g','x','LineWidth', 3);
            scatter(prj2(2), prj2(1), 'g','x','LineWidth', 3);
...
function DrawRectWindow(pt)
    line([pt(1,2) pt(2,2)], [pt(1,1) pt(2,1)],'Color',[0 0.5 1],'LineWidth',3);
    line([pt(2,2) pt(3,2)], [pt(2,1) pt(3,1)],'Color',[0 0.5 1],'LineWidth',3);
    line([pt(3,2) pt(4,2)], [pt(3,1) pt(4,1)],'Color',[0 0.5 1],'LineWidth',3);
    line([pt(4,2) pt(1,2)], [pt(4,1) pt(1,1)],'Color',[0 0.5 1],'LineWidth',3);   
end
